...
public static class TileRenderer
{
    public static BaseShape Tessellate(this MapFeatureData feature, ref BoundingBox boundingBox, ref PriorityQueue<BaseShape, int> shapes)
    {
        ...
        if (feature.Properties.Any(p => p.Key == MapElement.highway && MapFeature.HighwayTypes.Any(v => p.Value.ToString().StartsWith(v))))
        {
        ...
        else if (feature.Properties.Any(p => p.Key == MapElement.water) && feature.Type != GeometryType.Point)
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.Any(p => p.Key == MapElement.railway))
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.Any(p => p.Key == MapElement.natural && featureType == GeometryType.Polygon))
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.Any(p => p.Key == MapElement.boundary && p.Value == PropertyValue.forest))
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Properties.Any(p => p.Key == MapElement.landuse && (p.Value == PropertyValue.forest || p.Value == PropertyValue.orchard)))
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Forest);
            baseShape = geoFeature;
            shapes.Enqueue(geoFeature, geoFeature.ZIndex);
                     ...
                     => p.Key == MapElement.landuse && (p.Value == PropertyValue.residential || p.Value == PropertyValue.cemetery || p.Value == PropertyValue.industrial || p.Value == PropertyValue.commercial ||
                                                        p.Value == PropertyValue.square || p.Value == PropertyValue.construction || p.Value == PropertyValue.military || p.Value == PropertyValue.quarry ||
                                                        p.Value == PropertyValue.brownfield)))
        {
            var coordinates = feature.Coordinates;
            ...
            shapes.Enqueue(geoFeature, geoFeature.ZIndex);
                     ...
                     => p.Key == MapElement.landuse && (p.Value == PropertyValue.farm || p.Value == PropertyValue.meadow || p.Value == PropertyValue.grass || p.Value == PropertyValue.greenfield ||
                                                        p.Value == PropertyValue.recreation_ground || p.Value == PropertyValue.winter_sports || p.Value == PropertyValue.allotments)))
        {
            var coordinates = feature.Coordinates;
            ...
            shapes.Enqueue(geoFeature, geoFeature.ZIndex);
                 ...
                 feature.Properties.Any(p => p.Key == MapElement.landuse && (p.Value == PropertyValue.reservoir || p.Value == PropertyValue.basin)))
        {
            var coordinates = feature.Coordinates;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.Any(p => p.Key == MapElement.building))
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.Any(p => p.Key == MapElement.leisure))
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
        ...
        else if (feature.Type == GeometryType.Polygon && feature.Properties.Any(p => p.Key == MapElement.amenity))
        {
            var coordinates = feature.Coordinates;
            var geoFeature = new GeoFeature(coordinates, GeoFeature.GeoFeatureType.Residential);
            baseShape = geoFeature;
